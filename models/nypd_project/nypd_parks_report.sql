...
SELECT 
    ...
    date_part('hour' , dc.complaint_from_dt) AS complaint_hour,
...
FROM 
	...
	-- narrow the scope to parks
	INNER JOIN dim_parks dp ON 
		dp.parks_hkey = fc.parks_hkey 
		AND dp.parks != 'UNKNOWN'
	-- gather crime data
